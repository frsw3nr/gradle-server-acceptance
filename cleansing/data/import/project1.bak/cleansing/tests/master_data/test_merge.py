...
def test_merge1():
    ...
    Util().save_data(df2, 'data/classify', 'host_list.csv')
...
def test_merge2():
    ...
    # Util().save_data(df, 'data/classify', 'host_list.csv')

def test_merge3():
    collector = InventoryCollector()
    inventorys = collector.scan_inventorys('data/import/project3')
    inventory_tables = collector.load(inventorys)
    inventory_tables.save_csv('data/transfer')
...
def test_merge4():
    collector = InventoryCollector()
    inventorys = collector.scan_inventorys('data/import/net1')
    inventory_tables = collector.load(inventorys)
    inventory_tables.save_csv('data/transfer')
...
def test_merge5():
    ...
    collector = InventoryCollector()
    inventorys = collector.scan_inventorys('data/import/net1')
    inventorys.extend(collector.scan_inventorys('data/import/v1.24'))
