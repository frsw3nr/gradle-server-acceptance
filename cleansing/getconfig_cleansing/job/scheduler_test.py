...
from getconfig_cleansing.master_data.template.anken_jouhou import MasterDataAnkenJyouhou
from getconfig_cleansing.master_data.template.systemcode_list import MasterDataSystemcodeList
from getconfig_cleansing.master_data.template.mw_jouhou import MasterDataMiddlewareJyouhou
from getconfig_cleansing.master_data.template.openview_nnm_list import MasterDataOpenviewNnmList
from getconfig_cleansing.master_data.template.port_list import MasterDataPortList
from getconfig_cleansing.job.scheduler import Scheduler
...
class SchedulerTest(Scheduler):
    ...
    def transfer(self):
        ...
        inventorys = collector.scan_inventorys('tests/resources2/import')
