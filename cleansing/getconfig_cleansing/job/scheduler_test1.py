...
from getconfig_cleansing.ticket.ticket_port_list import TicketPortList
from getconfig_cleansing.ticket.ticket_relation import TicketRelation
...
class SchedulerTest(Scheduler):
    ...
    def transfer(self):
        ...
        Util().save_data(df, 'tests/resources/classify', 'hosts.csv')
    ...
    def regist(self):
        '''データ登録'''
        port_list = pd.read_csv('tests/resources/classify/hosts.csv')
