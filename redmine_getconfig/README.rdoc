...
ln -s ~/work/gradle/gradle-server-acceptance/redmine_getconfig ~/redmine/plugins/
```
...
```
GRANT ALL PRIVILEGES ON redmine2.* TO redmine2@"192.168.%" IDENTIFIED BY 'P@ssw0rd' WITH GRANT OPTION;
exit
```
